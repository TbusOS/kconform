...
- README and CHANGELOG: replaced placeholder `<your-fork>/kconform` URLs with the real `TbusOS/kconform` GitHub location in preparation for the first public push.
- README status line now reads "U-Boot feature-complete · first public release".

## [0.1.12] — 2026-04-24

### Added

- README rewritten to reflect the completed v0.1.x U-Boot verb surface. Quick start now walks a full workflow (detect → lint → verify → symbol → minimize → fragment → menuconfig). Added a Verbs table, a Lint rules table, and an accurate Supported platforms matrix.
- Initial CHANGELOG.md in Keep-a-Changelog format covering v0.1.0 through v0.1.11.
...
[0.1.10]: https://github.com/TbusOS/kconform/compare/v0.1.9...v0.1.10
[0.1.9]: https://github.com/TbusOS/kconform/compare/v0.1.8...v0.1.9
[0.1.8]: https://github.com/TbusOS/kconform/compare/v0.1.7...v0.1.8
[0.1.7]: https://github.com/TbusOS/kconform/compare/v0.1.6...v0.1.7
[0.1.6]: https://github.com/TbusOS/kconform/compare/v0.1.5...v0.1.6
[0.1.5]: https://github.com/TbusOS/kconform/compare/v0.1.4...v0.1.5
[0.1.4]: https://github.com/TbusOS/kconform/compare/v0.1.3...v0.1.4
[0.1.3]: https://github.com/TbusOS/kconform/compare/v0.1.2...v0.1.3
[0.1.2]: https://github.com/TbusOS/kconform/compare/v0.1.1...v0.1.2
[0.1.1]: https://github.com/TbusOS/kconform/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/TbusOS/kconform/releases/tag/v0.1.0
